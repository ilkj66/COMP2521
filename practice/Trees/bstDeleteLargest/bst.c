...
static void bstReadPrompt(char *traversal, int treeNo);
...
static struct node *reconstruct(int *preorder, int size);
static struct node *newNode(int value);

////////////////////////////////////////////////////////////////////////
// Reads in a tree from stdin

struct node *bstRead(int treeNo) {
	bstReadPrompt("preorder", treeNo);
...
static struct node *reconstruct(int *preorder, int size) {
	...
	struct node *t = newNode(preorder[0]);
